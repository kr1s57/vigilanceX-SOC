...
> **Version**: 3.55.112 | **Derniere mise a jour**: 2026-01-15
...
### Fichiers Publics (sur repo public)
| Fichier | Contenu |
|---------|---------|
| **README.md** | Documentation client - guide utilisateur et admin |

### Fichiers Internes (repo prive uniquement)
| Fichier | Contenu |
|---------|---------|
